  ...
  themeConfig: {
    ...
    sidebar: {
      '/ru/private/': [
        ...
        {
          text: 'Сервер и эксплуатация',
          items: [
            { text: i('database', 'PostgreSQL 18'), link: '/ru/private/postgres-18' },
        ...
        {
          text: 'Тарифы и продажи',
          items: [
            { text: i('tags', 'Тарифы'), link: '/ru/private/plans' },
            { text: i('mobile-screen', 'Устройства'), link: '/ru/private/extra-devices' },
            { text: i('temperature-half', 'Температура лида'), link: '/ru/private/lead-scoring' },
          ],
        },
        {
          text: 'Клиенты и автоматизация',
          items: [
            { text: i('headset', 'Поддержка и операторы'), link: '/ru/private/support-workflow' },
            { text: i('wand-magic-sparkles', 'ИИ-поддержка'), link: '/ru/private/ai-support' },
            { text: i('gears', 'Факторы автоматизаций'), link: '/ru/private/automation-factors' },
          ],
        },
        {
          text: 'Справка',
