...
**Шаг 9: Создайте директорию проекта**
...
Скачайте файл образа с [me.remnawavebot.dev/releases](https://me.remnawavebot.dev/releases).
  ...
  **Шаг 11: Создайте необходимые директории**
...
```bash
  ...
  **Шаг 12: Скачайте файлы переводов**
...
Скачайте `en.json` и `ru.json` из приватного канала и поместите в папку `translations`:
  ...
  **Шаг 13: Создайте конфигурацию Docker Compose**
...
```bash
  ...
  **Шаг 14: Создайте файл окружения**
...
:::
  ...
  **Шаг 15: Добавьте volume machine-id для лицензии**
