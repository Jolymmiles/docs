...
Сумма округляется до целых рублей (для RUB) или до двух знаков после запятой (для других валют). Количество добавляемых устройств должно быть кратно шагу тарифа, а новое общее количество — не больше максимума тарифа.
