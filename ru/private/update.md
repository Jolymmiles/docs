...
::: danger Обновляетесь на 7.1.0 и выше?
Начиная с 7.1.0 требуется PostgreSQL **18 или новее**. Если у вас всё ещё 17-я, сначала выполните [переход на PostgreSQL 18](/ru/private/postgres-18/) — сменой тега образа данные не переносятся.
:::
